...
const Skills = () => {
  ...
  return (
    <section id="skills" className="min-h-screen flex items-center justify-center bg-slate-900 py-10">
      <div className="bg-black/20 py-8 px-6 md:py-12 md:px-18 rounded-[25px] md:rounded-[35px] text-center shadow-2xl border border-slate-800 w-full max-w-sm md:max-w-4xl mt-10 md:mt-16">
